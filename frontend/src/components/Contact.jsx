...
// Import your images
import alza from './../img/alza.png' // Replace with your actual image path
import baja from './../img/baja.jpg' // Replace with your actual image path
                        ...
                        {prediction ? (
                            ...
                            <div role="status">
                                <div className='flex items-center justify-center mt-10'>
                                    <svg aria-hidden="true" className='' class="inline w-[5rem] h-[5rem] text-gray-200 animate-spin dark:text-gray-600 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
